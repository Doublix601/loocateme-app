  ...
  const handleSave = async () => {
    try {
      ...
      if (editType === 'firstName') {
        ...
        const res = await apiUpdateDemographics({
          birthdate: user.birthdate || undefined,
          gender: newValue || undefined,
        });
        const updated = res?.user || {};
        updateUser({
          ...user,
    ...
    <View style={{ flex: 1 }}>
              ...
              return (
                ...
                >
                  <View
                    style={[
                      styles.rowIcon,
                      { backgroundColor: isDark ? 'rgba(0,194,203,0.15)' : 'rgba(0,194,203,0.1)' },
                    ]}
                  >
      ...
      <Modal visible={modalVisible} transparent={true} animationType="fade">
        <View style={styles.modalContainer}>
          ...
          <View style={[styles.modalKeyboardView, { height: height - keyboardHeight }]} pointerEvents="box-none">
            <View style={[styles.modalCard, { backgroundColor: colors.surface }]}>
              <View
                style={[styles.modalIcon, { backgroundColor: isDark ? 'rgba(0,194,203,0.15)' : 'rgba(0,194,203,0.1)' }]}
              >
                    ...
                    <TouchableOpacity
                      ...
                      style={[
                        styles.modalInput,
                        {
                          ...
                          backgroundColor: isDark ? '#0f1115' : '#f7f9fa',
                      ...
                      <Text
                        style={
                          newValue === opt.key
                            ...
                            : [styles.genderPillText, textSecondaryStyle]
                        }
                      >
                        {opt.label}
                      </Text>
