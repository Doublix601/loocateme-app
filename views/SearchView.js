      ...
      >
            ...
            {item.photo ? (
              ...
              <View style={[styles.avatar, styles.avatarPh]}>
                <Text style={{ color: '#fff', fontWeight: '700' }}>
                  {(getDisplayName(item)[0] || 'U').toUpperCase()}
                </Text>
              </View>
            )}
            {item.isGhost && (
        ...
        <View style={styles.rowContent}>
          <View style={{ flexDirection: 'row', alignItems: 'center' }}>
            <Text style={[styles.rowText, { color: isDark ? '#fff' : colors.textPrimary }]} numberOfLines={1}>
              {getDisplayName(item)}
            </Text>
          ...
          {isLocation && (
            <Text
              style={{
                color: isDark ? '#eee' : colors.textPrimary,
            ...
            >
              ...
              {sharedFormatDistance(item.distance)}
            </Text>
          )}
          {!isLocation && item.isGhost && (
            <Text
              style={{
                color: isDark ? '#aaa' : colors.textPrimary,
                opacity: 0.7,
                fontSize: 11,
                marginLeft: 15,
                marginTop: 2,
